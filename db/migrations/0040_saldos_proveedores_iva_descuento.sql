-- Exponer iva_rate y descuento_pct en la vista saldos_proveedores.
-- Postgres CREATE OR REPLACE VIEW no admite insertar columnas nuevas en el
-- medio, asi que DROP + CREATE.
